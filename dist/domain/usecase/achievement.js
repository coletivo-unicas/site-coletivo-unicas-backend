...
var achievement_1 = require("./ucio/achievement");
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        data = _a.sent();
                        return [2 /*return*/, new achievement_1.ListAchievementsUseCaseResponse(data, null)];
                    case 2:
                        error_2 = _a.sent();
                        console.log(error_1.TAG_INTERNAL_SERVER_ERROR, error_2.message);
                        return [2 /*return*/, new achievement_1.ListAchievementsUseCaseResponse(null, new error_1.InternalServerError(error_2.message))];
