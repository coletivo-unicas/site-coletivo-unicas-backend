...
var options = { dialect: 'postgres', logging: false, host: 'ec2-52-206-182-219.compute-1.amazonaws.com', port: 5432, timezone: '-03:00', define: { timestamps: true }, dialectOptions: { ssl: { rejectUnauthorized: false } } };
