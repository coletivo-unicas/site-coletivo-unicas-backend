...
function getAchievement(ID) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, achievement_1.achievementModelSequelize.findByPk(ID, { raw: true })];
                case 1:
                    response = _a.sent();
                    return [2 /*return*/, response ? (0, achievement_2.toAchievementEntity)(response) : null];
            }
        });
    });
}
...
function listAchievements() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, achievement_1.achievementModelSequelize.findAll({ raw: true })];
                case 1:
                    response = _a.sent();
