...
exports.ListProjectsUseCaseRepository = exports.GetProjectUseCaseRepository = void 0;
...
var ListProjectsUseCaseRepository = /** @class */ (function () {
    ...
    ListProjectsUseCaseRepository.prototype.listProjects = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, project_1.listProjects)()];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    return ListProjectsUseCaseRepository;
}());
exports.ListProjectsUseCaseRepository = ListProjectsUseCaseRepository;
var GetProjectUseCaseRepository = /** @class */ (function () {
    function GetProjectUseCaseRepository() {
    }
    GetProjectUseCaseRepository.prototype.getProject = function (ID) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, project_1.getProject)(ID)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    GetProjectUseCaseRepository.prototype.listAchievementsByProjectID = function (projectID) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, achievement_1.listAchievementsByProjectID)(projectID)];
    ...
    GetProjectUseCaseRepository.prototype.listAchievementImagesByAchievementID = function (achievementID) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, achievement_image_1.listAchievementImagesByAchievementID)(achievementID)];
    ...
    return GetProjectUseCaseRepository;
}());
exports.GetProjectUseCaseRepository = GetProjectUseCaseRepository;
